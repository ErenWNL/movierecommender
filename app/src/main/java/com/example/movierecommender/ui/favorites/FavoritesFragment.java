package com.example.movierecommender.ui.favorites;
...
public class FavoritesFragment extends Fragment implements MovieAdapter.OnMovieActionListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel.getFavoriteMovies().observe(getViewLifecycleOwner(), movies -> {
            ...
            // Show empty view if no favorite movies
